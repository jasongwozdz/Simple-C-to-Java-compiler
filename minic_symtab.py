...
from minic_type_promotion import safe_assign, conversion_fun
...
class SymTab:
    ...
    def declare_scalar(self, sym, return_type, data_type):
        '''
        ...
        if return_type != data_type:
            raise ValueError("return type and data_type dont match")

        # enter the symbol with its value in the current scope
        val = ('scalar-val', data_type, CURR_VAR)
        CURR_VAR += 1
